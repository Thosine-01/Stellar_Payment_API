...
export default function TransactionFilterSidebar({
  ...
  // Local search state to prevent immediate re-renders during typing
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-[#E8E8E8] bg-[#F9F9F9] py-2.5 pl-10 pr-4 text-sm text-[#0A0A0A] placeholder:text-[#6B6B6B] focus:border-[var(--pluto-500)] focus:bg-white focus:outline-none transition-all"
              />
